      ...
      <section className="customer-service-area ptb-70">
        <div className="container">
          <div className="customer-service-content">
            <h3>
              <i className="bx bx-gift"></i> Shipping Times and Costs
            </h3>
            <ul>
            ...
            <h3>
              <i className="bx bx-credit-card-front"></i> Payment Methods
            </h3>
            ...
            <ul>
              ...
              <li>
                MedQ features a Fast Checkout option, allowing you to securely
              ...
              <li>
                ...
                the website <a href="#">paypal.com.</a>
              </li>
            </ul>
            <h3>
              <i className="bx bx-sync"></i> Exchanges, Returns and Refunds
            </h3>
            <p>
              ...
              credit. Refunds will be charged back to the original form of
              payment used for purchase. Customer is responsible for shipping
