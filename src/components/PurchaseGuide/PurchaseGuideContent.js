...
const PurchaseGuideContent = () => {
  return (
    <section className="purchase-guide-area ptb-70">
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <div className="purchase-guide-content">
              ...
              <p>
                <i>This Purchase Guide was last updated on July 1, 2020.</i>
              </p>
              ...
              <p>
                ...
                data from third-party platforms you connect with{" "}
                <strong>MedQ</strong>. We also collect some data automatically,
              ...
              <ul>
                ...
                <li>
                  ...
                  and other types of local data storage. Your wireless device
                  may also allow you to control whether location or other data
                  is collected and shared. You can manage Adobe’s LSOs through
                ...
                <li>
                  ...
                  European Union, visit the Your Online Choices site. To opt out
                  of Google’s display advertising or customize Google Display
                  Network ads, visit the Google Ads Settings page. To opt out of
                  Taboola’s targeted ads, see the Opt-out Link in their Cookie
                  Policy.
                </li>
                <li>
