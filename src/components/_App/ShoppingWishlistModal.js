        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className="products-cart-content">
              <div className="products-cart d-flex align-items-center">
                <div className="products-image">
                  <Link href="#">
                    <img src="/img/products/products-img1.jpg" alt="image" />
                  </Link>
                </div>

                <div className="products-content">
                  <h3>
                    <Link href="#">Coronavirus Face Mask</Link>
                  </h3>
              ...
              <div className="products-cart d-flex align-items-center">
                ...
                <div className="products-content">
                  <h3>
                    <Link href="#">Infrared Thermometer Gun</Link>
                  </h3>
                  <div className="products-price">
                    <span>1</span>
                    <span>x</span>
            ...
            <div className="products-cart-btn">
              <Link href="#">
                <a className="default-btn">View Shopping Cart</a>
              </Link>
            </div>
          </div>
        </div>
