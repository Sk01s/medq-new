...
const HotDealOfferStyleOne = () => {
  ...
  return (
    <div className="hot-deal-area ptb-70">
      <div className="container">
        <div className="row">
          <div className="col-lg-6 col-md-12">
            <div className="hot-deal-content">
              <span className="sub-title">Deal of the Month</span>
              <h2>
                Up to <span>80%</span> OFF. All Sales Are Final!
              </h2>
...
export default HotDealOfferStyleOne;
